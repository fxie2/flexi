...
!@{
!> Variables to pass depending on the desired attribute type.
!> Possible choices for attributes: integer, real, string, logical
REAL              ,INTENT(OUT),OPTIONAL,TARGET :: RealArray(nVal)
INTEGER           ,INTENT(OUT),OPTIONAL,TARGET :: IntegerArray(nVal)
REAL              ,INTENT(OUT),OPTIONAL,TARGET :: RealScalar
INTEGER           ,INTENT(OUT),OPTIONAL,TARGET :: IntegerScalar
CHARACTER(LEN=255),INTENT(OUT),OPTIONAL,TARGET :: StrScalar
CHARACTER(LEN=255),INTENT(OUT),OPTIONAL,TARGET :: StrArray(nVal)
LOGICAL           ,INTENT(OUT),OPTIONAL        :: LogicalScalar
!@}
!----------------------------------------------------------------------------------------------------------------------------------
! LOCAL VARIABLES

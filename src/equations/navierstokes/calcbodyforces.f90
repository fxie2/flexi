...
!----------------------------------------------------------------------------------------------------------------------------------
! INPUT/OUTPUT VARIABLES
REAL, INTENT(IN)               :: U_Face(PP_nVar,0:PP_N,0:PP_N) !< (IN) solution on face
...
! INPUT/OUTPUT VARIABLES
REAL, INTENT(IN)               :: U_Face(PP_nVar,0:PP_N,0:PP_N)      !< (IN) solution on face
REAL, INTENT(IN)               :: gradUx_Face(PP_nVar,0:PP_N,0:PP_N) !< (IN) sln. gradients x-dir on face
REAL, INTENT(IN)               :: gradUy_Face(PP_nVar,0:PP_N,0:PP_N) !< (IN) sln. gradients y-dir on face
REAL, INTENT(IN)               :: gradUz_Face(PP_nVar,0:PP_N,0:PP_N) !< (IN) sln. gradients z-dir on face
REAL, INTENT(IN)               :: SurfElem(0:PP_N,0:PP_N)            !< (IN) face surface
REAL, INTENT(IN)               :: NormVec(3,0:PP_N,0:PP_N)           !< (IN) face normal vectors

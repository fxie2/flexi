...
!==================================================================================================================================
!@{ Named notetype parameters
!==================================================================================================================================
CHARACTER(LEN=255),PARAMETER :: NodeTypeG    = 'GAUSS'
CHARACTER(LEN=255),PARAMETER :: NodeTypeGL   = 'GAUSS-LOBATTO'
CHARACTER(LEN=255),PARAMETER :: NodeTypeCL   = 'CHEBYSHEV-GAUSS-LOBATTO'
CHARACTER(LEN=255),PARAMETER :: NodeTypeVISU = 'VISU'
!@}
#if (PP_NodeType==1)

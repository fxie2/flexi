...
!==================================================================================================================================
!> Contains subroutines to collect and condense mesh topology information and define communication neighbours
!==================================================================================================================================
...
!==================================================================================================================================
!> Build list of SideIDs sorting sides with BCs, Mortars, inner- and MPI-neighbours into groups
!> and define inter-processor communication patterns.
!==================================================================================================================================
...
!==================================================================================================================================
!> Condense mesh topology from mesh pointer structure into arrays with mappings (SideToElem,ElemToSide)
!==================================================================================================================================
...
DO iElem=1,nElems
  ...
  DO LocSideID=1,6
    ...
    IF(aSide%nMortars.GT.0)THEN !mortar side
      ...
      DO iMortar=1,aSide%nMortars
        IF (aSide%SideID.LE.lastMortarInnerSide)THEN
        ...
        ELSE
          Mortar_nbSideID(iMortar,aSide%SideID-offsetMortarMPI)=aSide%MortarSide(iMortar)%sp%SideID
          Mortar_flip(    iMortar,aSide%SideID-offsetMortarMPI)=aSide%MortarSide(iMortar)%sp%Flip
        END IF
      END DO !iMortar
...
#ifdef MPI
!==================================================================================================================================
!> Set flip of MINE sides to zero, therefore send flip of MINE to other processor, so YOUR sides get their corresponding flip>0
!==================================================================================================================================

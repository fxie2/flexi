...
!==================================================================================================================================
!> Module containing routines to read the mesh and BCs from a HDF5 file and build up a pointer structure 
!==================================================================================================================================
...
IF(nGlobalElems.LT.nProcessors)&
  CALL Abort(__STAMP__,'ERROR: Number of elements (1) is smaller then number of processors (2)!',nGlobalElems,REAL(nProcessors))
...
#ifdef MPI
CALL MPI_REDUCE(ReduceData,ReduceData_glob,9,MPI_INTEGER,MPI_SUM,0,MPI_COMM_WORLD,iError)
...
IF(MPIRoot)THEN
  ...
  WRITE(UNIT_stdOut,'(A,A34,I0)')' |','nMortarSides | ',ReduceData(9) !nBCSides
